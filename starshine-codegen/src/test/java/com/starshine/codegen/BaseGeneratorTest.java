...
public class BaseGeneratorTest {
    ...
    // 包名（根据你的项目修改）
    protected static final String parentPackage = "com.starshine";
    /**
     * 执行数据库脚本
     */
    protected static void initDataSource(DataSourceConfig dataSourceConfig) throws SQLException {
        ...
        InputStream inputStream = H2CodeGeneratorTest.class.getResourceAsStream("/db/migration/init.sql");
